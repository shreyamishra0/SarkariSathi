...
if (isset($_GET['tracking']) && !empty($_GET['tracking'])) {
    ...
    // Fixed query: office_name comes from users table via join
    $stmt = $conn->prepare("
        SELECT a.*, s.name as section_name, u.office_name
        FROM applications a
...
// Get all applications for this citizen - Fixed query
$all_applications = [];
$stmt = $conn->prepare("
    SELECT a.*, s.name as section_name, u.office_name
    FROM applications a
...
<div class="main-content">
    ...
    <?php if ($search_result): ?>
        <div class="application-detail">
            ...
            <?php if (!empty($search_result['officer_notes'])): ?>
    ...
    <div class="applications-section">
        ...
        <?php if (empty($all_applications)): ?>
            <div class="empty-state">
                ...
                <a href="<?= BASE_URL ?>/citizen/sections.php" class="btn">
