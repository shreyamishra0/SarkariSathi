...
<div class="sidebar">
    ...
    <i class="fas fa-brain"></i> Smart Track <span style="background:#667eea;color:white;padding:2px 6px;border-radius:8px;font-size:0.7rem;margin-left:5px;">AI</span>
</a>
...
<div class="quick-actions-grid">
    <a href="<?= BASE_URL ?>/citizen/sections.php" class="action-card">
        <i class="fas fa-folder-open"></i>
        <span>Browse Services</span>
    </a>
    <a href="<?= BASE_URL ?>/citizen/queue-booking.php" class="action-card">
    ...
    <a href="<?= BASE_URL ?>/citizen/complaints.php" class="action-card">
